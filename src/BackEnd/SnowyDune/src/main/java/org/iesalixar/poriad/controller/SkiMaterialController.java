...
public class SkiMaterialController {
	...
	// Servicio que devuelve un negocio de material de ski, en función de su
	// identificador
	...
	// Servicio que devuelve una lista de negocios de material de ski en función de
	// su status
	@PreAuthorize("hasRole('USER')")
	...
	// Servicio que actualiza el status de un negocio de material de ski
	// relacionandolo con una estación
	...
	public ResponseEntity<?> updateStationIdClasses(@PathVariable Long id, @RequestParam Long station) {
		...
		logger.info(
				"Servicio consumido /skiMaterial/updateStatusSkiMaterialStation/" + id + ", con estación " + station);
