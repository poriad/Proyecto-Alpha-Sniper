...
public class CommentController {
	...
	public ResponseEntity<?> updateCommentStation(@RequestParam Long userId, @RequestParam Long stationId,@RequestParam Long commentId){
		...
		logger.info("Servicio consumido /comment/update" +", con la estación: " + stationId + ", el usuario: " + userId + " y el comentario: " + commentId);
	...
	public ResponseEntity<?> updateCommentHotel(@RequestParam Long userId, @RequestParam Long hotelId,@RequestParam Long commentId){
		...
		logger.info("Servicio consumido /comment/update" +", con el hotel: " + hotelId + ", el usuario: " + userId + " y el comentario: " + commentId);
		
		return new ResponseEntity(new Mensaje("Comentario actualizado correctamente"),HttpStatus.OK);
		
	}
	
	// Servicio que relaciona un comentario con un negocio de clases y con un usuario
	@PreAuthorize("hasRole('USER')")
	...
	public ResponseEntity<?> updateCommentClasses(@RequestParam Long userId, @RequestParam Long classesId,@RequestParam Long commentId){
		...
		logger.info("Servicio consumido /comment/update" +", con el negocio de clases: " + classesId + ", el usuario: " + userId + " y el comentario: " + commentId);
		
		return new ResponseEntity(new Mensaje("Comentario actualizado correctamente"),HttpStatus.OK);
		
	}
	
	// Servicio que relaciona un comentario con un negocio de material de ski y con un usuario
	@PreAuthorize("hasRole('USER')")
	...
	public ResponseEntity<?> updateCommentSkiMaterial(@RequestParam Long userId, @RequestParam Long skiMaterialId,@RequestParam Long commentId){
		...
		logger.info("Servicio consumido /comment/update" +", con el negocio de material de ski: " + skiMaterialId + ", el usuario: " + userId + " y el comentario: " + commentId);
		
		return new ResponseEntity(new Mensaje("Comentario actualizado correctamente"),HttpStatus.OK);
		
	}
	
	// Servicio que relaciona un comentario con un negocio de alquiler de vehículos y con un usuario
	@PreAuthorize("hasRole('USER')")
	...
	public ResponseEntity<?> updateCommentCarRental(@RequestParam Long userId, @RequestParam Long carRentalId,@RequestParam Long commentId){
		...
		logger.info("Servicio consumido /comment/update" +", con el negocio de alquiler de vehículos: " + carRentalId + ", el usuario: " + userId + " y el comentario: " + commentId);
