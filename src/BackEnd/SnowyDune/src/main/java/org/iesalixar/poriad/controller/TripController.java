...
public class TripController {
	...
	// Servicio que devuelve el listado de viajes que un usuario tiene para realizar
	// el checkout
	@PreAuthorize("hasRole('USER')")
	...
	// Servicio que actualiza un viaje, asignandole los servicios seleccionados y el
	// carrito del usuario
	@PreAuthorize("hasRole('USER')")
	@PutMapping("/updateTrip")
	public ResponseEntity<?> updateTrip(@RequestParam Long id, @RequestParam Long userId, @RequestParam Long stationId,
			@RequestParam Long hotelId, @RequestParam Long classesId, @RequestParam Long skiMaterialId,
			@RequestParam Long carRentalId, @RequestParam Long cartId) {
